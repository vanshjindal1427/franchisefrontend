...
function MoreDetails() {
    ...
    //     let url = "https://franchisebackend-production-a6c5.up.railway.app/admin/moreDetails"
    ...
    async function handleApprove(email) {
        ...
        let url = "https://franchisebackend-production-a6c5.up.railway.app/admin/approveApplication";
    ...
    async function handleDecline(email) {
        // alert(email);
        let obj = { emailid: email };
        let url = "https://franchisebackend-production-a6c5.up.railway.app/admin/declineApplication";
        let resp = await axios.post(url, obj, {
            headers: { "Content-Type": "application/x-www-form-urlencoded" },
        });
        alert(resp.data);
    ...
    async function handleFranchise(email) {
        ...
        let url = "https://franchisebackend-production-a6c5.up.railway.app/admin/franchiseApplication";
        let resp = await axios.post(url, obj, {
            headers: { "Content-Type": "application/x-www-form-urlencoded" },
        });
        alert(resp.data);
