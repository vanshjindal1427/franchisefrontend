...
function FranchiseLogin() {
    ...
    const handleSubmit = async (e) => {
        ...
        //     let url = 'http://localhost:2007/franchise/franchiselogin';
        ...
        try {
            ...
            if (credentials.emailid === "admin@sstbathinda.com") {
                const response = await axios.post('http://localhost:2007/admin/login', credentials, {
                    headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
                });
            ...
            const response = await axios.post('http://localhost:2007/franchise/franchiselogin', credentials, {
                headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
            });
